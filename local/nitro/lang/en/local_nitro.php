...
$string['consentprovider'] = 'Whatever {$a} reads here goes to the company that runs this AI, and may stay in the history of your conversation there, outside Moodle.';
$string['consentread'] = 'read your course content, participants, submissions and grades;';
...
$string['privacy:metadata:aiclient'] = 'The AI client the user connected (for example Claude or Microsoft 365 Copilot). What a tool reads is sent to that client, and so to the company that runs it, where it may stay in the conversation history outside Moodle.';
$string['privacy:metadata:aiclient:coursecontent'] = 'Course content the tool reads: sections, activities, pages and their dates.';
$string['privacy:metadata:aiclient:grades'] = 'Grades and feedback comments.';
$string['privacy:metadata:aiclient:participants'] = 'Names, roles, groups and last course access of the course participants.';
$string['privacy:metadata:aiclient:submissions'] = 'Submission status and, when asked for, the submitted text, links and file names.';
...
$string['privacy:metadata:feedback'] = 'Feedback about nitro that a teacher approved, mailed to the feedback address set by the admin.';
$string['privacy:metadata:feedback:message'] = 'The text the teacher approved, with the site name and URL and the version numbers.';
